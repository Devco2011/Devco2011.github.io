        ...
        <>
            ...
            <Container id="light-blue-container" fluid>
                ...
                <Row className="justify-content-md-center mb-3 mt-5 pt-5 pb-3">
                    <Col className="col-12 col-md-4 mb-5 pr-4 border-right">
                        <div className="images mt-3">
                            <HashLink to="/CaseStudies/Vaccine#top"><img className="vaccineCS" src="../../images/vaccineCS.png" height="100%" width="101%" alt="View of a design project." /></HashLink>
                        </div>
                    ...
                    <Col className="col-12 col-md-4 mb-5 pl-4 border-right">
                        <div className="images mt-3">
                    ...
                    <Col className="col-12 col-md-4 mb-4 pl-4">
                        <div className="images mt-3">
                            <HashLink to="/CaseStudies/TidyFamily#top"><img className="tidyFamHome" src="../../images/vue-scoreboard.png" height="91%" width="100%" alt="Homepage view of Tidy Family web app." /></HashLink>
                        </div>
                        <h6 className="section-title mt-2">Horseshoes Scoreboard</h6>
                        <ScrollAnimation animateIn="animate__animated animate__fadeIn"><p>
