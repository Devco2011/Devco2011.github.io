        ...
        <>
            <Container id="light-blue-container" fluid>
                ...
                <Row className="justify-content-md-center pt-4">
                    <Col className="col-12 col-md-6">
                        <div className="about-div">
                            <ScrollAnimation animateIn="animate__animated animate__fadeIn"><p class="lightBlue">I am also a nature lover, trail runner, gardener, history buff, and vegan. I have a fear of heights and bugs. I believe we can all make the world a better place and I love a good IPA.</p>
