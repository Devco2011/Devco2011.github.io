                ...
                <Row className="justify-content-md-center">
                    ...
                    <Col className="col-12 col-md-8">
                        <div className="about-div">
                            ...
                            <ScrollAnimation animateIn="animate__animated animate__fadeIn"><p className="p-3">When thinking about what would be relevant about my life to share with you here, I came
                ...
                <Row className="justify-content-md-center pt-3">
                    <Col className="col-12 col-md-3 p-4 border-right">
                        <div>
                            ...
                            <ScrollAnimation animateIn="animate__animated animate__fadeIn"><p>I have looked at life from many different perspectives. I came to the field of technology after
                            ten years of being a full-time performing singer and songwriter. Before that, I owned a small residential construction business. I have four kids, one is
                                a cancer survivor. I’ve known struggle, success, and all points in between. </p><p><strong>When it comes to empathy, I have a deep well of experiences to draw from.
                    ...
                    <Col className="col-12 col-md-3 p-4 border-right">
                        <div>
                            ...
                            <ScrollAnimation animateIn="animate__animated animate__fadeIn"><p>Years of songwriting, recording, and performing have taught me the value of everyone in the room being
                            comfortable enough to put their worst idea on the table. In Nashville, it’s normal for songwriter splits to be equal, even if one writer didn’t write a single line
                                ...
                                <p><strong>My experience at Nashville Software School taught me how to collaborate remotely. Our cohort was 100% remote, full-time, for six months.
                                </strong></p></ScrollAnimation>
                        </div>
                    </Col>
                    <Col className="col-12 col-md-3 p-4">
                        <div>
                            <h5 className="section-title">PURPOSE</h5>
                            <ScrollAnimation animateIn="animate__animated animate__fadeIn"><p>The people I work with and the work itself are most important to me. I know what it’s like to hang, have
                                fun, and accomplish great things together. </p>

                                <p><strong>The best situation is one where the team is positive and supportive and the work is challenging and rewarding.
                                </strong></p></ScrollAnimation>
                        </div>
                    </Col>
                </Row>
